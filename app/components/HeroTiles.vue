...
<template>
  ...
  >
    ...
    <span
      class="text-h1 text-h1--keep-size right-0px absolute bottom-[-10px] left-[-15px] mx-auto block text-center text-white shadow-2xl sm:left-[60px] md:bottom-[-120px] md:text-green-900 lg:left-0 lg:hidden"
    >
      30.08.25
    </span>
  </div>
