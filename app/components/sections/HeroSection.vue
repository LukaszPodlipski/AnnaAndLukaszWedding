<script setup lang="ts">
  import HeroTiles from '~/components/HeroTiles.vue';
...
<template>
  <div
    id="hero-section"
    class="hero-section flex flex-col items-center justify-center gap-[120px] overflow-auto bg-white !px-0 pb-12"
  >
    <div class="content-wrapper-wide !p-0">
      <div
